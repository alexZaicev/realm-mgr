...
var file_realm_mgr_v1_service_proto_rawDesc = []byte{
	...
	0x72, 0x6f, 0x74, 0x6f, 0x32, 0x91, 0x02, 0x0a, 0x13, 0x52, 0x65, 0x61, 0x6c, 0x6d, 0x4d, 0x61,
	...
	0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0x1b, 0x5a, 0x19, 0x72, 0x65, 0x61, 0x6c,
...
var file_realm_mgr_v1_service_proto_goTypes = []interface{}{
	...
	(*GetRealmResponse)(nil),     // 3: realm_mgr.v1.GetRealmResponse
	(*CreateRealmResponse)(nil),  // 4: realm_mgr.v1.CreateRealmResponse
	(*ReleaseRealmResponse)(nil), // 5: realm_mgr.v1.ReleaseRealmResponse
}
var file_realm_mgr_v1_service_proto_depIdxs = []int32{
	...
	3, // 3: realm_mgr.v1.RealmManagerService.GetRealm:output_type -> realm_mgr.v1.GetRealmResponse
	4, // 4: realm_mgr.v1.RealmManagerService.CreateRealm:output_type -> realm_mgr.v1.CreateRealmResponse
	5, // 5: realm_mgr.v1.RealmManagerService.ReleaseRealm:output_type -> realm_mgr.v1.ReleaseRealmResponse
