...
func (_m *RealmRepository) CreateRealm(ctx context.Context, realm entities.Realm) error {
...
func (_m *RealmRepository) DeleteRealm(ctx context.Context, realmID uuid.UUID, statuses ...entities.Status) error {
...
func (_m *RealmRepository) GetRealm(ctx context.Context, realmID uuid.UUID, status entities.Status) (entities.Realm, error) {
...
func (_m *RealmRepository) UpdateRealm(ctx context.Context, realm entities.Realm, currentStatus entities.Status) error {
...
type mockConstructorTestingTNewRealmRepository interface {
	mock.TestingT
	Cleanup(func())
}
...
func NewRealmRepository(t mockConstructorTestingTNewRealmRepository) *RealmRepository {
